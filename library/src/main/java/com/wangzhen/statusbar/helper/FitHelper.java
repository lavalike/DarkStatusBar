...
/**
 * 适配暗色状态栏
 * Created by wangzhen on 2017/12/25.
 */
public class FitHelper {
     ...
     */
    public static boolean fitFlyme(Window window, boolean dark) {
     ...
     * MIUI Android 6.0以上需要使用原生适配方法
     *
     * @param window 需要设置的窗口
     * @param dark   是否把状态栏字体及图标颜色设置为深色
     * @return boolean 成功执行返回true
     */
    public static boolean fitMIUI(Window window, boolean dark) {
        boolean result = false;
        if (window != null) {
